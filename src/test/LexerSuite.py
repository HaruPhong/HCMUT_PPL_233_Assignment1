...
class LexerSuite(unittest.TestCase):
    ...
    def test_119(self):
        self.assertTrue(
            TestLexer.test(
                """ a: string = \"Hello;""", "a,:,string,=,Unclosed String: Hello;", 119
            )
        )
    ...
    def test_120(self):
        self.assertTrue(
            TestLexer.test(
                "main: function void() {}", "main,:,function,void,(,),{,},<EOF>", 120
            )
        )
    ...
    def test_121(self):
        self.assertTrue(
            TestLexer.test(
                "a, b, c: integer = 10, 4;", "a,,,b,,,c,:,integer,=,10,,,4,;,<EOF>", 121
            )
        )

    def test_122(self):
        self.assertTrue(
            TestLexer.test("a: float = .25e+20;", "a,:,float,=,.25e+20,;,<EOF>", 122)
        )
    ...
    def test_125(self):
        self.assertTrue(
            TestLexer.test("a: boolean = true;", "a,:,boolean,=,true,;,<EOF>", 125)
        )
    ...
    def test_127(self):
        self.assertTrue(
            TestLexer.test(
                "foo: function void() inherit fact { return; }",
                "foo,:,function,void,(,),inherit,fact,{,return,;,},<EOF>",
                127,
            )
        )
    ...
    def test_132(self):
        self.assertTrue(
            TestLexer.test(
                """ \"Hello\n, this is me\" """, "Unclosed String: Hello", 132
            )
        )
    ...
    def test_133(self):
        self.assertTrue(
            TestLexer.test(
                "a: integer = foo(1, 2);", "a,:,integer,=,foo,(,1,,,2,),;,<EOF>", 133
            )
        )
    ...
    def test_135(self):
        self.assertTrue(
            TestLexer.test("a: float = 1_23e96;", "a,:,float,=,123e96,;,<EOF>", 135)
        )
    ...
    def test_137(self):
        self.assertTrue(
            TestLexer.test("x: integer = 1;", "x,:,integer,=,1,;,<EOF>", 137)
        )
    ...
    def test_149(self):
        self.assertTrue(
            TestLexer.test("x: boolean = true;", "x,:,boolean,=,true,;,<EOF>", 149)
        )
    ...
    def test_153(self):
        self.assertTrue(
            TestLexer.test("""\"This is John""", "Unclosed String: This is John", 153)
        )

    def test_154(self):
        self.assertTrue(
            TestLexer.test(
                """\"He is my brother\t\"""", "He is my brother\t,<EOF>", 154
            )
        )
    ...
    def test_156(self):
        self.assertTrue(
            TestLexer.test(
                "a: integer = 1_23.456;", "a,:,integer,=,123.456,;,<EOF>", 156
            )
        )
    ...
    def test_160(self):
        self.assertTrue(
            TestLexer.test("a_int: integer = 0;", "a_int,:,integer,=,0,;,<EOF>", 160)
        )

    def test_161(self):
        self.assertTrue(
            TestLexer.test(
                "x: array [3] of boolean;", "x,:,array,[,3,],of,boolean,;,<EOF>", 161
            )
        )
    ...
    def test_163(self):
        self.assertTrue(
            TestLexer.test(
                """a: string = \"abcdef\";""", "a,:,string,=,abcdef,;,<EOF>", 163
            )
        )

    def test_164(self):
        self.assertTrue(
            TestLexer.test("a: integer = 8 - 2;", "a,:,integer,=,8,-,2,;,<EOF>", 164)
        )
    ...
    def test_165(self):
        self.assertTrue(
            ...
            a@198: integer = 20;
                ...
                "main,:,function,void,(,),{,a,Error Token @",
                165,
            )
        )
    ...
    def test_173(self):
        self.assertTrue(
            TestLexer.test("auto: integer = 39", "auto,:,integer,=,39,<EOF>", 173)
        )

    def test_174(self):
        self.assertTrue(
            TestLexer.test(
                """a: string = \"123@#$456\";""", "a,:,string,=,123@#$456,;,<EOF>", 174
            )
        )
    ...
    def test_177(self):
        self.assertTrue(
            TestLexer.test("""\"abc\\"abc\\"\"""", """abc\\"abc\\",<EOF>""", 177)
        )

    def test_178(self):
        self.assertTrue(
            TestLexer.test(
                'a: string = "PPL\n";', "a,:,string,=,Unclosed String: PPL", 178
            )
        )
    ...
    def test_180(self):
        self.assertTrue(
            TestLexer.test("a: boolean = true;", "a,:,boolean,=,true,;,<EOF>", 180)
        )

    def test_181(self):
        self.assertTrue(
            TestLexer.test("""\"abc\\v\"""", "Illegal Escape In String: abc\\v", 181)
        )

    def test_182(self):
        self.assertTrue(
            TestLexer.test(
                "foo: function array[3] of string(a: array [3] of string) {}",
                "foo,:,function,array,[,3,],of,string,(,a,:,array,[,3,],of,string,),{,},<EOF>",
                182,
            )
        )
    ...
    def test_184(self):
        self.assertTrue(
            TestLexer.test(
                "a: array [2_0, 3 + 20, 1_92 / 16] of boolean;",
                "a,:,array,[,20,,,3,+,20,,,192,/,16,],of,boolean,;,<EOF>",
                184,
            )
        )
    ...
    def test_186(self):
        self.assertTrue(
            TestLexer.test(
                "main: function bool() { return true; }",
                "main,:,function,bool,(,),{,return,true,;,},<EOF>",
                186,
            )
        )
    ...
    def test_187(self):
        self.assertTrue(
            TestLexer.test(
                "a, b, c: integer = 1, 2;", "a,,,b,,,c,:,integer,=,1,,,2,;,<EOF>", 187
            )
        )
    ...
    def test_189(self):
        ...
        self.assertTrue(
            TestLexer.test(
                input,
                "foo,:,function,void,(,),{,},fact,:,function,integer,(,),inherit,foo,{,return,0,;,},<EOF>",
                189,
            )
        )
    ...
    def test_190(self):
        self.assertTrue(
            TestLexer.test("1_234_56_7.214857e-10", "1234567.214857e-10,<EOF>", 190)
        )

    def test_191(self):
        self.assertTrue(
            TestLexer.test(
                """\"Hello \\"World\\"\"""", """Hello \\"World\\",<EOF>""", 191
            )
        )
    ...
    def test_192(self):
        self.assertTrue(
            TestLexer.test(
                """\"abc_efg\\v!#$\"""", """Illegal Escape In String: abc_efg\\v""", 192
            )
        )
    ...
    def test_195(self):
        self.assertTrue(
            TestLexer.test("id1: integer = id2;", "id1,:,integer,=,id2,;,<EOF>", 195)
        )
    ...
    def test_197(self):
        self.assertTrue(
            TestLexer.test(
                "err: function void(inherit out a: integer, b: array [2] of float) inherit err1 {}",
                "err,:,function,void,(,inherit,out,a,:,integer,,,b,:,array,[,2,],of,float,),inherit,err1,{,},<EOF>",
                197,
            )
        )
    ...
    def test_198(self):
        self.assertTrue(
            TestLexer.test(
                "a: integer = 2_147_483_647", "a,:,integer,=,2147483647,<EOF>", 198
            )
        )
    ...
    def test_199(self):
        self.assertTrue(
            TestLexer.test(
                """\"Hello\\0\"""", "Illegal Escape In String: Hello\\0", 199
            )
        )
